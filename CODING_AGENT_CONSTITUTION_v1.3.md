...
**Version:** 1.3  
**Revision:** 2026-09-04 - faster safe delivery, bounded authorization reuse, and explicit activation boundaries
**Status:** Normative  
**Supersedes:** `CODING_AGENT_CONSTITUTION_v1.2.md`  
...
For `ai-automation-department`, `main` MUST require pull requests and the required `quality` CI check, prohibit force pushes/deletion, require review, and require code-owner review for security/policy-sensitive paths as defined in the active Repository Governance Policy (`REPOSITORY_GOVERNANCE_v1.2.yaml` at this revision).
