...
**Supersedes:** `CODING_AGENT_DEVELOPMENT_PRINCIPLES_SYSTEM_PROMPT_v1.5.md`  
**Normative companion:** `CODING_AGENT_CONSTITUTION_v1.3.md`  
**Machine-readable companion:** `CODING_AGENT_POLICY_v1.3.yaml`  
**Repository-governance companion:** `REPOSITORY_GOVERNANCE_v1.2.yaml`
...
For repositories governed by `REPOSITORY_GOVERNANCE_v1.2.yaml`, preserve the configured requirements for pull requests, approvals, CODEOWNERS, stale-review handling, required checks, up-to-date branches, force-push restrictions, deletion restrictions, direct-push restrictions, and CRITICAL review requirements.
...
- `CODING_AGENT_CONSTITUTION_v1.3.md` remains normative.
- `CODING_AGENT_POLICY_v1.3.yaml` is the aligned machine-readable policy for handbook v1.6.
- `REPOSITORY_GOVERNANCE_v1.2.yaml` is the aligned repository-governance companion for handbook v1.6.
