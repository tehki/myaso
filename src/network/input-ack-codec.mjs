...
export const INPUT_ACK_BYTES = 12;

export function encodeInputAck({ processedClientTick, serverTick }) {
...
export function decodeInputAck(packet) {
  ...
  if (view.byteLength !== INPUT_ACK_BYTES) throw new RangeError("input acknowledgement must be 12 bytes");
